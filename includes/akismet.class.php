 ...
 * 
 * 
 * https://code.google.com/p/akismet-php4/wiki/ClassDocumentation
 *
 * Akismet PHP4 class
 * 
 * <b>Usage</b>
...
class Akismet_TWCC extends AkismetObject {
	var $apiPort = 80;
	 ...
	 * @return	Akismet
	 */
	function Akismet_TWCC($blogUrl, $apiKey, $comment = array()) {
		$this->blogUrl = $blogUrl;
		$this->apiKey  = $apiKey;
